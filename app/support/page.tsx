...
import {
  ...
  ArrowRight, Shield, Mail, ChevronDown,
} from "lucide-react";
    ...
    <PageLayout illustration="/images/support.png" leftFixed>
      <div style={{ display: "flex", flexDirection: "column", gap: 30 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          <p style={{ fontSize: 14, fontWeight: 500, color: "#767676", margin: 0, letterSpacing: "0.14px" }}>
            COMMON ISSUES
          </p>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          <p style={{ fontSize: 14, fontWeight: 500, color: "#767676", margin: 0 }}>
            ...
            {activeTab === "phone" && (
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                ...
                <div style={{ height: 44, display: "flex", alignItems: "center", gap: 30, borderBottom: "1px solid #d9d9d9", position: "relative" }}>
                  ...
                  <input type="tel" placeholder="Enter your number" value={phone}
          ...
          <button type="button" onClick={() => router.push("/support/logged-in")}
