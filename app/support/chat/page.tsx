...
export default function Page() {
  ...
  return (
    ...
    >
      ...
      {/* Chat area — negative margin to go edge-to-edge within card */}
      <div style={{ flex: 1, backgroundColor: "rgba(185,185,185,0.05)", display: "flex", flexDirection: "column", justifyContent: "space-between", margin: "0 -30px -30px -30px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 30, alignItems: "center", paddingTop: 60 }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 10, alignItems: "center", paddingLeft: 20, paddingRight: 20 }}>
            ...
            <p style={{ fontSize: 14, color: "#a09898", textAlign: "center", marginTop: 0, marginBottom: 0, lineHeight: "22.75px", letterSpacing: "0.14px" }}>
