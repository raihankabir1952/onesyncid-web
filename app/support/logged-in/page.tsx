      ...
      <div className="relative flex-1 w-full" style={{ minHeight: 900 }}>
        ...
        <div
          ...
          style={{
            ...
            minHeight: 776, maxHeight: "calc(100vh - 120px)",
            borderRadius: 8, boxShadow: "0px 0px 5.5px 1.5px rgba(0,0,0,0.25)",
            overflow: "hidden",
          }}
        >
          {/* STICKY HEADER */}
          <div style={{ flexShrink: 0, padding: "24px 30px 20px", backgroundColor: "#fff", borderBottom: "1px solid #f0f0f0", position: "sticky", top: 0, zIndex: 10 }}>
          ...
          {/* SCROLLABLE BODY */}
          <div style={{ flex: 1, overflowY: "auto", padding: "20px 30px 30px", display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              <div style={{ backgroundColor: "rgba(2,95,201,0.05)", border: "1px solid rgba(2,95,201,0.2)", borderRadius: 12, overflow: "hidden" }}>
                <button type="button" onClick={() => router.push("/support/chat")} style={{ width: "100%", display: "flex", alignItems: "flex-start", gap: 8, padding: "20px 16px", background: "none", cursor: "pointer", fontFamily: "inherit", textAlign: "left" as const }}>
                  <div style={{ width: 24, height: 24, backgroundColor: "rgba(2,95,201,0.1)", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              <button type="button" onClick={() => router.push("/support/no-account")} style={{ width: "100%", height: 44, backgroundColor: "#025fc9", color: "#fff", fontSize: 16, fontWeight: 500, border: "none", borderRadius: 8, cursor: "pointer", fontFamily: "inherit" }}>
                Continue
              </button>
            </div>
