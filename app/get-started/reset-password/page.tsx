      ...
      <div className="relative flex-1 w-full" style={{ minHeight: 900 }}>
        ...
        <div className="absolute bg-white flex flex-col justify-between" style={{ right: "clamp(16px, 4.2vw, 60px)", top: 75, width: "clamp(320px, 41.7vw, 600px)", height: 776, borderRadius: 8, boxShadow: "0px 0px 5.5px 1.5px rgba(0,0,0,0.25)", padding: 30 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 40 }}>
            ...
            <p style={{ fontSize: 30, fontWeight: 600, color: "#000", margin: 0 }}>Reset your password</p>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 40 }}>
                ...
                {activeTab === "phone" && (
                  <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                    ...
                    <div style={{ height: 44, display: "flex", alignItems: "center", gap: 8, borderBottom: "1px solid #d9d9d9", position: "relative" }}>
                      ...
                      <input type="tel" placeholder="Enter your number" value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} style={{ flex: 1, border: "none", outline: "none", fontSize: 16, color: "#000", fontFamily: "inherit", background: "transparent" }} />
                    </div>
                  </div>
                )}
              ...
              {/* Send OTP */}
              <button type="button" onClick={() => router.push("/get-started/reset-password/create")} style={{ width: "100%", height: 44, backgroundColor: "#025fc9", color: "#fff", fontSize: 16, fontWeight: 500, border: "none", borderRadius: 8, cursor: "pointer", fontFamily: "inherit" }}>
                Send OTP
              </button>
            </div>
