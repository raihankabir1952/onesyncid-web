...
const COUNTRIES = [
  ...
  // { name: "United States",  dialCode: "+1",   flag: "/images/flag-us.png" },
  // { name: "United Kingdom", dialCode: "+44",  flag: "/images/flag-uk.png" },
  // { name: "India",          dialCode: "+91",  flag: "/images/flag-in.png" },
  // { name: "Pakistan",       dialCode: "+92",  flag: "/images/flag-pk.png" },
];
...
export default function Page() {
  ...
  const handleSendOtp = () => {
    ...
    if (activeTab === "phone" && phoneNumber.replace(/\D/g, "").length < 6) {
