...
// TODO: get destination from route params / session / context
// e.g. with searchParams: export default function OtpPage({ searchParams }) { const dest = searchParams.phone }
      ...
      <div className="relative flex-1 w-full" style={{ minHeight: 900 }}>
        ...
        */}
        ...
        >
          ...
          {/* OTP illustration — otp.png (Figma: 500×514) */}
          ...
          {/* Tagline — Figma: #0052b4 (different blue from main screens) */}
